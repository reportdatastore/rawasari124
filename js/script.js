...
const reportsData = {
    daily: [
        { id: 'daily1', title: 'Line bar', icon: 'fa-chart-line', link: 'https://example.com/line-bar-report', detail: 'Laporan Line Bar: Menampilkan grafik penjualan per jam, item terlaris, dan performa shift.' },
        { id: 'daily2', title: 'LOGBOOK', icon: 'fa-book', link: 'https://example.com/logbook', detail: 'LOGBOOK Harian: Catatan kejadian operasional, masalah, dan solusi dari tim restoran.' },
        { id: 'daily3', title: 'BRIEFING', icon: 'fa-users', link: 'https://example.com/briefing', detail: 'BRIEFING: Ringkasan arahan pagi, target harian, dan menu spesial hari ini.' },
        { id: 'daily4', title: 'TCMH', icon: 'fa-clipboard-list', link: 'https://example.com/tcmh', detail: 'TCMH (Team Customer Morning Huddle): Evaluasi layanan pelanggan dan keluhan.' },
        { id: 'daily5', title: 'BINCARD', icon: 'fa-id-card', link: 'https://example.com/bincard', detail: 'BINCARD: Kartu inspeksi kebersihan dan kelayakan area dapur & ruang makan.' },
        { id: 'daily6', title: 'MONITORING suhu', icon: 'fa-temperature-high', link: 'https://example.com/monitoring-suhu', detail: 'Monitoring Suhu: Pengecekan suhu kulkas, freezer, dan ruang penyimpanan bahan baku.' }
    ],
    weekly: [
        { id: 'weekly1', title: 'Traffic count', icon: 'fa-chart-simple', link: 'https://example.com/traffic-count', detail: 'Traffic Count: Jumlah pengunjung per hari dalam seminggu, tren kenaikan/penurunan.' },
        { id: 'weekly2', title: 'Fix order', icon: 'fa-truck', link: 'https://example.com/fix-order', detail: 'Fix Order: Pemesanan tetap bahan baku mingguan dari supplier utama.' },
        { id: 'weekly3', title: 'Line bar schedule', icon: 'fa-calendar-alt', link: 'https://example.com/linebar-schedule', detail: 'Line bar Schedule: Jadwal shift bartender dan staf bar untuk minggu ini.' }
    ],
    monthly: [
        { id: 'monthly1', title: 'PNL', icon: 'fa-chart-pie', link: 'https://example.com/pnl', detail: 'PNL (Profit & Loss): Laporan laba rugi bulanan, pendapatan vs pengeluaran.' },
        { id: 'monthly2', title: 'SDM', icon: 'fa-user-tie', link: 'https://example.com/sdm', detail: 'SDM: Laporan kehadiran karyawan, performa tim, dan rencana pelatihan bulan depan.' }
    ],
    insidental: [
        { id: 'insidental1', title: 'Target', icon: 'fa-bullseye', link: 'https://example.com/target', detail: 'Target: Pencapaian target bulanan vs realisasi, analisis gap dan strategi.' },
        { id: 'insidental2', title: 'Bisnis plan', icon: 'fa-chart-line', link: 'https://example.com/bisnis-plan', detail: 'Bisnis Plan: Rencana pengembangan restoran, ekspansi, dan inovasi menu.' }
    ]
};
