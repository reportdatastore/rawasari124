...
const reportsData = {
    daily: [
        { id: 'daily1', title: 'Line bar', icon: 'fa-chart-line', link: 'selector/select_linebar.html', detail: 'Laporan Line Bar: Menampilkan grafik penjualan per jam, item terlaris, dan performa shift.' },
